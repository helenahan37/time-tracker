					...
					<div className="w-full lg:w-1/2">
						<div className="max-w-md xl:max-w-lg">
							...
							<p className="max-w-md text-lg leading-8 mb-12">
								Effortlessly track and manage tasks based on different time periods such as weeks, months, and overall
								total. The application allows users to view and analyze their task data according to specific time
								ranges. Users can easily calculate and monitor the total time spent on tasks for each period.
							</p>
