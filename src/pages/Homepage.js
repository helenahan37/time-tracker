					...
					<div className="flex flex-wrap -mx-4 items-center mb-16">
						<div className="w-full lg:w-1/2 px-4 mb-24 lg:mb-0">
							<div className="max-w-md md:max-w-lg mx-auto xl:mx-0">
								...
								<h1 className="font-heading text-4xl md:text-5xl mb-6">Track Your Time, Boost Your Productivity</h1>
								<p className="text-lg leading-8 mb-10">
									Effortlessly manage and track your tasks to improve productivity and achieve your goals. Stay
									organized, prioritize effectively, and maximize your time with our task time tracking application.
								</p>
			...
			<section className="relative pt-16 lg:pb-16 overflow-hidden">
				<div className="container px-4 mx-auto">
					<div className="flex flex-wrap -mx-4 items-center">
							...
							<div className="max-w-md md:max-w-lg mx-auto xl:mx-0">
								<div className="w-full">
									<div className="max-w-md xl:max-w-lg">
										<h2 className="font-heading text-3xl sm:text-4xl mb-6">Features of Time Tracking Application</h2>
										<p className="max-w-md text-lg leading-8 mb-12">
											Effortlessly track and manage tasks based on different time periods such as weeks, months, and
											overall total. The application allows users to view and analyze their task data according to
											specific time ranges. Users can easily calculate and monitor the total time spent on tasks for
											each period.
										</p>
										...
										<div className="flex items-center mb-4">
											...
											<span className="font-heading font-medium">Protected Routes</span>
										</div>
										<div className="flex items-center">
											...
											<span className="font-heading font-medium">Track Tasks by Weeks, Months, and Total</span>
										</div>
									</div>
								</div>
							</div>
						...
						<div className="w-full lg:w-1/2 px-4">
							<img className="block mx-auto xl:mx-0" src={work} alt="work" />
						</div>
					</div>
				</div>
			</section>
